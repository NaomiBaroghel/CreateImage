...
public class Color {
	...
	{
		return new java.awt.Color((float) this._r, (float) this._g, (float) this._b);
...
/*	public primitives.Color ConvertJ() {
		
		return new primitives.Color((double) this.getRed(), (double) this.getGreen(), (double) this.getBlue());
	...
	public Color add(Color... colors) {
		double r = this._r, g = this._g, b = this._b;
		for (Color c : colors) {
			r = r + c._r;
			g = g + c._g;
			b = b + c._b;
